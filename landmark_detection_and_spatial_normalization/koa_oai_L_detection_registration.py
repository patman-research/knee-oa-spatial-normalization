...
model = YOLO("best_L.pt") # best from YOLOv11m train

DirPath = './4' # directori class knee
...
for File in Files:
    ...
    pts2 = np.float32([[26,40],[273,60],[46,240],[253,245]])  # Size of the Transformed Image #L  
