...
# CONFIG
DATA_DIR = "/home/informatika/workspace/dataset/INASS_2_REV_3/4T_DETECT/dataset_resplit52"
BATCH_SIZE = 16
NUM_CLASSES = 5
...
# DATASET
test_dataset  = datasets.ImageFolder(os.path.join(DATA_DIR, 'set_test_seed_52_sigma_10'), transform=test_transform)
...
for model_name in model_list:
    ...
    MODEL_PATH = f"best_{model_name}_corn_seed_52_stratified.pth"
